...
CREATE TABLE IF NOT EXISTS DataOps.IOT_RAW_v001.ABC_permanent_not_valide_db_schema_prefix (
    id INT,
    name STRING,
    created_at TIMESTAMP_TZ
);

CREATE TABLE IF NOT EXISTS IOT_RAW_v001.ABC_permanent_not_valide_schema_prefix (
    id INT,
    name STRING,
    created_at TIMESTAMP_TZ
);